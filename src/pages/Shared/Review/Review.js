...
const Review = (props) => {
    ...
    return (
        <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
            <article className="overflow-y-scroll m-4 overflow-x-hidden h-80 rounded-lg shadow-md lg:min-h-full hover:shadow-2xl duration-500">
                ...
                <body className="flex justify-evenly items-center mb-2">
